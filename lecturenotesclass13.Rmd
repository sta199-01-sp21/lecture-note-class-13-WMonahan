...
```{r data_manhattan}
manhattan <- read_csv("~/R/lecture-note-class-13-WMonahan/manhattan.csv")
```
...
We can be 95% confident that the median price of 1-bedroom apartments in 
Manhattan is between \$2,162 and $2,875.
...
We can be 95% confident that the proportion of mice that died while on the 
treatment is between 0.69 and 0.793.
